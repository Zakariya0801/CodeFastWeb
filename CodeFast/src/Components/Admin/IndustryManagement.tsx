...
useEffect(() => {
  ...
  if(loading) return (
    <div className="w-full p-6">
      ...
      <h2 className="text-2xl font-bold mb-6">All Industry</h2>
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedStudent.completedCourses.map((course:any, index:number) => (
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedStudent.ongoingCourses.map((course:any, index:number) => (
