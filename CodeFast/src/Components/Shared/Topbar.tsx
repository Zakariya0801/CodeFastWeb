      ...
      <div className="w-full flex justify-end p-4">
        ...
        <div className="flex max-w-md flex-1 items-center px-8">
            ...
            <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm outline-none placeholder:text-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
            </div>
        </div>
